...
const handleSubmit = event =>{
  ...
  const products ={productName,brand,category,price,rating,ProductDetails}
    ...
    <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="brand" id="brand" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Brand" required=""/>
            </div>
            <div className="col-span-6 sm:col-span-3">
