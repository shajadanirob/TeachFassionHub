...
const UpdateProducts = () => {
    ...
    const handleUpdate = event => {
        ...
        fetch(`  https://teachfausion-server-site-jbxvnszc0-shajada-nirobs-projects.vercel.app/update/${lodar._id}`, {
          method: "PUT",
          headers: {
        ...
        <div className="p-6 space-y-6">
          <form onSubmit={handleUpdate}>
            ...
            <div className="p-6 border-t border-gray-200 rounded-b">
              <button className="text-white bg-[#8696a0] focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Update product</button>
            </div>
